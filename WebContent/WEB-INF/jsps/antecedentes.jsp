			...
			<div class="container">
				...
				<input type="hidden" id="dni" path="dni" name="dni" placeholder="DNI" value="${dni}">
                    ...
                    <div class="form-group">
                       ...
                       <textarea wrap="hard"  class="form-control" id="tesista_maestria" path="tesista_maestria" name="tesista_maestria" placeholder="Tesista Maestría"></textarea>               		
                    </div>
                    <!-- Tesistas grado -->                
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea wrap="hard" class="form-control" id="pasantes_id_y_facademica" path="pasantes_id_y_facademica" name="pasantes_id_y_facademica" placeholder="Pasantes de I+D y/o formación académica"></textarea>                	
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea wrap="hard"  class="form-control" id="actividades_divulgacion" path="actividades_divulgacion" name="actividades_divulgacion"
                         placeholder="Actividades de divulgación CyT"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea wrap="hard"  class="form-control" id="extension_rural_industrial" path="extension_rural_industrial" name="extension_rural_industrial"
                         placeholder="Extensión rural o industrial"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea wrap="hard"  class="form-control" id="prestacion_servicios_sociales" path="prestacion_servicios_sociales" name="prestacion_servicios_sociales" placeholder="Prestación de servicios sociales y/o comunitarios"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Producción y/o divulgación artística o cultural"></textarea>
                    </div>
                    <!-- Otro tipo de actividad de extensión --> 
                    <div class="form-group">
                        <label for="inputOtroTipoActividadExtension">Otro tipo de actividad de extensión</label>
                        <textarea wrap="hard"  class="form-control" id="otro_tipo_actividad" path="otro_tipo_actividad" name="otro_tipo_actividad" placeholder="Otro tipo de actividad de extensión"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea wrap="hard"  class="form-control" id="evaluacion_personal" path="evaluacion_personal" name="evaluacion_personal" placeholder="Evaluación de personal CyT Y jurado de tesis y/o premios"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea wrap="hard"  class="form-control" id="evaluacion_programas" path="evaluacion_programas" name="evaluacion_programas" placeholder="Evaluación de programas/proyectos de I+D y/o extensión"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea wrap="hard" class="form-control" id="otro_tipo_evaluacion" path="otro_tipo_evaluacion" name="otro_tipo_evaluacion" placeholder="Otro tipo de evaluación"></textarea>
           			</div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea wrap="hard"  class="form-control" id="estancias_pasantias" path="estancias_pasantias" name="estancias_pasantias" placeholder="Estancias y pasantías"></textarea> 
 					</div>                          
                    ...
                    <div class="form-group">
                        ...
                        <textarea wrap="hard"  class="form-control" id="operacion_mantenimiento" path="operacion_mantenimiento" name="operacion_mantenimiento" placeholder="Operación y mantenimiento de sistemas de alta complejidad"></textarea>
                    </div>
                    <!-- Producción --> 
                    <div class="form-group">
                        <label for="inputProduccion">Producción</label>
                        <textarea wrap="hard"  class="form-control" id="produccion" path="produccion" name="produccion" placeholder="Producción"></textarea>
                    </div>
                    <!-- Normalización --> 
                    <div class="form-group">
                        <label for="inputNormalizacion">Normalización</label>
                        <textarea wrap="hard" class="form-control" id="normalizacion" path="normalizacion" name="normalizacion" placeholder="Normalización"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        path=" ejercicio_profesion_ambito_no_academico" name=" ejercicio_profesion_ambito_no_academico" placeholder="Ejercicio de la profesión en el ámbito no académico"></textarea>
                    </div>
                    <!-- Otra actividad CyT --> 
                    <div class="form-group">
				...
				<input type="hidden" id="dni" path="dni" name="dni" placeholder="DNI" value="${dni}">
					...
					<div class="form-group">
						<label for="inputBecarios">Becarios: </label>
						<span style="white-space:pre"><c:out value="${antecedentes.becario}" /></span>
					</div>

					<!-- Tesistas doctorado-->
					<div class="form-group">
						<label for="inputTesistaDoctorado">Tesista Doctoral:</label>
						<span style="white-space:pre"><c:out value="${antecedentes.tesista_doctoral}" /></span>
					</div>
					...
					<div class="form-group">
						<label for="inputTesistaMaestria">Tesista Maestría:</label>
						<span style="white-space:pre"><c:out value="${antecedentes.tesista_maestria}" /></span>
					</div>

					<!-- Tesistas grado -->
					<div class="form-group">
						<label for="inputTesistaMaestria">Tesista Grado:</label>
						<span style="white-space:pre"><c:out value="${antecedentes.tesista_grado}" /></span>
					</div>

					<!-- Investigadores -->
					<div class="form-group">
						<label for="inputInvestigadores">Investigadores:</label>
						<span style="white-space:pre"><c:out value="${antecedentes.investigadores}" /></span>
					</div>
					...
					<div class="form-group">
						...
						<span style="white-space:pre"><c:out value="${antecedentes.pasantes_id_y_facademica}" /></span>
					</div>

					<!-- Personal de apoyo a la I+D -->
					<div class="form-group">
						<label for="inputPersonalDeApoyoID">Personal de apoyo a la I+D :</label>
						<span style="white-space:pre"><c:out value="${antecedentes.personal_apoyo_id}" /></span>
					</div>
					...
					<div class="form-group">
						...
						<span style="white-space:pre"><c:out value="${antecedentes.financiamiento_cientifico_tecnologico}" /></span>
					</div>
					...
					<div class="form-group">
						...
						<span style="white-space:pre"><c:out value="${antecedentes.actividades_divulgacion}" /></span>
					</div>
					...
					<div class="form-group">
						...
						<span style="white-space:pre"><c:out value="${antecedentes.extension_rural_industrial}" /></span>
					</div>
					...
					<div class="form-group">
						...
						<span style="white-space:pre"><c:out value="${antecedentes.prestacion_servicios_sociales}" /></span>
					</div>
					...
					<div class="form-group">
						...
						<span style="white-space:pre"><c:out value="${antecedentes.produccion_divulgacion_artistica}" /></span>
					</div>
					...
					<div class="form-group">
						...
						<span style="white-space:pre"><c:out value="${antecedentes.otro_tipo_actividad}" /></span>
					</div>
					...
					<div class="form-group">
						...
						<span style="white-space:pre"><c:out value="${antecedentes.evaluacion_personal}" /></span>
					</div>
					...
					<div class="form-group">
						...
						<span style="white-space:pre"><c:out value="${antecedentes.evaluacion_programas}" /></span>
					</div>
					...
					<div class="form-group">
						<label for="inputEvaluacionInstitucional">Evaluacion
							institucional: </label>
						<span style="white-space:pre"><c:out value="${antecedentes.evaluacion_institucional}" /></span>
					</div>
					...
					<div class="form-group">
						<label for="inputOtroTipoEvaluacio">Otro tipo de
							evaluación: </label>
						<span style="white-space:pre"><c:out value="${antecedentes.otro_tipo_evaluacion}" /></span>
					</div>
					...
					<div class="form-group">
						<label for="inputBecas">Becas: </label>
						<span style="white-space:pre"><c:out value="${antecedentes.becas}" /></span>
					</div>
					...
					<div class="form-group">
						<label for="inputEstanciasPasantias">Estancias y
							pasantías: </label>
						<span style="white-space:pre"><c:out value="${antecedentes.estancias_pasantias}" /></span>
					</div>
					...
					<div class="form-group">
						...
						<span style="white-space:pre"><c:out value="${antecedentes.operacion_mantenimiento}" /></span>
					</div>

					<!-- Producción -->
					<div class="form-group">
						<label for="inputProduccion">Producción: </label>
						<span style="white-space:pre"><c:out value="${antecedentes.produccion}" /></span>
					</div>

					<!-- Normalización -->
					<div class="form-group">
						<label for="inputNormalizacion">Normalización: </label>
						<span style="white-space:pre"><c:out value="${antecedentes.normalizacion}" /></span>
					</div>
					...
					<div class="form-group">
						...
						<span style="white-space:pre"><c:out value="${antecedentes.ejercicio_profesion_ambito_no_academico}" /></span>
					</div>

					<!-- Otra actividad CyT -->
					<div class="form-group">
						<label for="inputOtraActividad">Otra actividad CyT: </label>
						<span style="white-space:pre"><c:out value="${antecedentes.otra_actividad_cyt}" /></span>
					</div>
				</form:form>
				</c:otherwise>
